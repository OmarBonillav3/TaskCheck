...
import { View, KeyboardAvoidingView, Platform, Button, StyleSheet, TextInput, Keyboard, TouchableWithoutFeedback } from 'react-native'; 
...
export default function NotasScreen ({ navigation }) {
  ...
  // }
    ...
    return (
      ...
      style={{ flex: 1 }}
      behavior={Platform.OS === 'ios' ? 'padding' : undefined} // 'padding' funciona bien en iOS
    >
