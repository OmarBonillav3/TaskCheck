...
// --------------------------------------------------------------------------------------------------------------------
                                // NOTAS IMPORTANTES
// - Necesito agregar una funcion la cual me permita crear un usurio y que guarde datos como 
// nombre para presentarlo en la pantalla de Home y en la pantall de usario.
// Que estos datos se guarden en la memoria del celular para que no se pierdan al cerrar la app (Usando AsyncStorage).


                                    //OBSERVACIONES
// - SOLO SE GUARDA UN USUARIO NO SE SI ES MALO PERO BUENO AHI TENEMOS UN "PROBLEMA"
// - Osea en ves que regsitar otro usuario este solo se sobre escribe.
// --------------------------------------------------------------------------------------------------------------------
    ...
    return (
        ...
        <View style={styles.container}>
            ...
            <TouchableOpacity style={styles.BotonRegistrar} onPress={GuardarDatos}>
                <Text style={styles.TxtBotonRegistrar}> Regístrarse </Text>
            </TouchableOpacity> 
            <TouchableOpacity style={styles.BotonIniciarSession} onPress={() => navigation.navigate ('Login') }>
                <Text style={styles.TxtBotonInicarSession}> Iniciar Session </Text>
            </TouchableOpacity>
